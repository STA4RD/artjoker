...
$existUser      = [];
if ((isset($_POST['name'])) && (isset($_POST['email']) && (isset($_POST['territory_id']) &&
			(($_POST['name']) != '') && ($_POST['email']) != '') && ($_POST['territory_id']) != '')) {

	$result = $userModel->select('email', $_POST['email']);
	if ($result->email !== $_POST['email']) {
		$user = new User($_POST['name'], $_POST['email'], $_POST['territory_id']);
...
//$sities = $territoryModel->select('ter_mask', [3, 4, 5]);
//
//$district = $territoryModel->select('ter_mask', [1, 2]);

//$result = $userModel->select('email', $_POST['email']);
//$result = $userModel->select('email', '111@mail.com');
//var_dump($result);

//var_dump($regions);
//var_dump(json_encode($region));
//var_dump(json_encode($region));
